import { Card, CardContent, Stack, Typography, Button, Box, Divider } from "@mui/material";
...
function Footer() {
  ...
  >
    <Section id="contact" title="Contact" subtitle="Let’s talk anything C++/graphics roles and projects.">
      <Card>
        <CardContent>
          <Stack spacing={1.2}>
