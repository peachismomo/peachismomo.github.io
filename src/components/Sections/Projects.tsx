...
function getPublicAssetUrl(project: Project, assetFileName: string) {
    const file = assetFileName.startsWith("/") ? assetFileName.slice(1) : assetFileName;
        ...
        >
            <Stack spacing={2.2}>
                {visibleProjects.map((p) => {
                    ...
                    const headerUrl = p.headerImage ? getPublicAssetUrl(p, p.headerImage.src) : "";
                    ...
                    return (
                        <Card key={p.name}>
                            ...
                            <CardActions sx={{ px: 2, pb: 2 }}>
                                {(p.fullDescription || (p.additionalImages?.length ?? 0) > 0) && (
                                    <Button
                                        size="small"
